      ...
      <div
        ...
        >
          ...
          <FadeIn delay={0.2} direction="down" padding fullWidth>
            <h1 className="mt-[90px] text-center text-5xl leading-tight xs:text-[54px] text-white max-w-[1050px]">{heroTitle}</h1>
          </FadeIn>
          ...
          <FadeIn delay={0.2} direction="up" padding fullWidth>
            <div className="relative full-w xs:w-[460px] mt-11">
              <input 
              type="text" 
              placeholder="Search" 
